...
const page = () => {
  return (
    <div className="mt-36 md:px-10 lg:px-36 flex gap-[6%]">
      <div className="w-[63%] ">
        <h1 className="text-xl font-semibold">Billing Information</h1>
        <div className="flex gap-3 justify-between text-sm my-4 w-full">
          <div className="flex-col flex gap-1 w-1/3 ">
        ...
        <div className="flex-col flex gap-1 ">
          ...
          <input
            ...
            className="border p-2  rounded-md outline-none text-sm"
          />
        </div>
        <div className="flex gap-3 justify-between text-sm my-4 w-full">
          <div className="flex-col flex gap-1 w-1/3 ">
      ...
      <div className="w-[31%]  p-4 border rounded-xl">
        ...
        <button className="w-full text-sm bg-lime-600 py-2.5 rounded-full text-white mt-2">
            Place Order
          </button>
      </div>
    </div>
